...
@pytest.fixture
def heros():
    hero_fire=Hero(HeroElement.FIRE,20,3750,2500,100,30)
    hero_earth=Hero(HeroElement.EARTH,20,3750,2500,100,30)
    hero_water=Hero(HeroElement.WATER,20,3750,2500,100,30)
    hero_fire_adv=Hero(HeroElement.FIRE,20,3750,2500,100,30)
    hero_earth_adv=Hero(HeroElement.EARTH,20,3750,2500,100,30)
    hero_water_adv=Hero(HeroElement.WATER,20,3750,2500,100,30)
